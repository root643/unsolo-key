...
/* Define : TIMER_RES_DIVIDER
   ...
   increase this value.
        */
#define NSECS_PER_SEC              FUNCONF_SYSTEM_CORE_CLOCK
// #define CORETIMETYPE               uint64_t
#define GETMYTIME(_t)              (*_t = (CORETIMETYPE)SysTick->CNT)
#define MYTIMEDIFF(fin, ini)       ((fin) - (ini))
#if defined( FUNCONF_SYSTICK_USE_HCLK ) && FUNCONF_SYSTICK_USE_HCLK && !defined(CH32V10x)
#define TIMER_RES_DIVIDER          1
#else
#define TIMER_RES_DIVIDER          8
#endif
...
{
  SystemInit();
  printf("Starting Coremark benchmark at %luMHz\n", (uint32_t)FUNCONF_SYSTEM_CORE_CLOCK/1000000);
