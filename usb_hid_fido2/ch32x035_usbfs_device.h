...
/* Endpoint Buffer */
extern volatile __attribute__ ((aligned(4))) uint8_t USBFS_EP0_Buf[];
extern volatile __attribute__ ((aligned(4))) uint8_t USBFS_EP2_Buf[];
...
extern __attribute__ ((aligned(4))) uint8_t  HID_Report_Buffer[];
